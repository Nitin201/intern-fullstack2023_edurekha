...
const movieCard = (movie) =>
    `<div class="col">
          <div class="card">
            <a class="card-media" href="https://www.freepik.com/free-vector/home-movie-background-with-popcorn_7856049.htm#query=movie&position=0&from_view=keyword&track=sph">
    ...
    if (items && items.length > 0) {
        items.map((item) => {
            ...
            if (poster_path) {
                ...
                poster_path = "https://www.freepik.com/free-vector/home-movie-background-with-popcorn_7856049.htm#query=movie&position=0&from_view=keyword&track=sph"
            }
